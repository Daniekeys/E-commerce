...
const [shippingData, setShippingData] = useState({});
            ...
            const nextStep = () => setSActiveStep((prevActiveStep) => prevActiveStep + 1 );
            const backStep = () => setSActiveStep((prevActiveStep) => prevActiveStep - 1 );
            const next = (data) => {
    ...
    return (
        ...
        variant='h4' align='center'>
            ...
            <Stepper activeStep={0} classsName={classes.stepper}>
            {steps.map((step) => (
                <Step key={step}>
